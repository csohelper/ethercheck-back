...
colors_16 = [
    ...
    "#fdae61",  # 45°  – оранжевый
    "#fee08b",  # 67.5° – жёлто-оранжевый (светлый, но различимый)
    "#e6f598",  # 90°  – лайм
    "#abdda4",  # 112.5° – зелёный
    "#66c2a5",  # 135° – бирюзово-зелёный
    "#3288bd",  # 157.5° – синий
    "#5e4fa2",  # 180° – индиго
    "#9e62b3",  # 202.5° – фиолетовый
    "#d53e9f",  # 225° – маджента
    "#f46eb4",  # 247.5° – розовый
    "#ff79c6",  # 270° – ярко-розовый
    "#ff7f91",  # 292.5° – коралловый
    "#ff9a6b",  # 315° – персиковый
    "#ffb34d",  # 337.5° – ярко-оранжевый
]
